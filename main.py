    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            if (batch_id + 1) % args.log_interval == 0:
                msg = "{}\tEpoch {}:\t[{}/{}]\tcontent: {:.6f}\tstyle: {:.6f}\ttotal: {:.6f}".format(time.ctime(), e + 1, count, len(train_dataset), agg_content_loss / (batch_id + 1),
...
def main():
    ...
    train_arg_parser.add_argument("--dataset", type=str, default='./dataset',
    ...
    eval_arg_parser.add_argument("--output-image", type=str, default='./',
